      ...
      return (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', padding: '1rem' }}>
          <div className="glass-panel" style={{ padding: '1rem' }}>
            <img src="/crafting.png" alt="Crafting Tame Ball" style={{ width: '100%', borderRadius: '12px', border: '1px solid var(--glass-border)', aspectRatio: '16/9', objectFit: 'cover'  }} />
          ...
          <div className="glass-panel" style={{ padding: '1rem' }}>
            <img src="/golden.png" alt="Golden Retriever Spawn" style={{ width: '100%', borderRadius: '12px', border: '1px solid var(--glass-border)', aspectRatio: '16/9', objectFit: 'cover' }} />
          ...
          <div className="glass-panel" style={{ padding: '1rem' }}>
            <img src="/zombie.png" alt="Zombie Pet" style={{ width: '100%', borderRadius: '12px', border: '1px solid var(--glass-border)', aspectRatio: '16/9', objectFit: 'cover'  }} />
